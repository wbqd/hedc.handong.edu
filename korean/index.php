...
//-- fin mod : categories hierarchy ----------------------------------------------------------------
	...
	$template->assign_vars(array(
		...
		'CAT_DESC'	=> get_object_lang($viewcatkey, 'desc'),
		...
		'L_THEME_SEARCH' => $lang['theme_search'],

		'L_MODERATOR' => $lang['Moderators'], 
		'L_FORUM_LOCKED' => $lang['Forum_is_locked'],
		'L_MARK_FORUMS_READ' => $lang['Mark_all_forums'], 

		'U_SEARCH_NEW_IN' => append_sid('search.'.$phpEx.'?search_id=newposts&search_where='.$viewcatkey),
		'U_SEARCH_SELF_IN' => append_sid('search.'.$phpEx.'?search_id=egosearch&search_where='.$viewcatkey),
		'U_SEARCH_UNANSWERED_IN' => append_sid('search.'.$phpEx.'?search_id=unanswered&search_where='.$viewcatkey),
		'U_RECENT_IN' => append_sid("recent.$phpEx"),
