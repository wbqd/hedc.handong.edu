...
if( $mode != "" )
{
	if( $mode == "edit" || $mode == "add" )
	{
		...
		$template->set_filenames(array(
			"body" => "service/ranks_edit_body.tpl")
		);
	...
	else if( $mode == "save" )
	{
		...
		log_action('update[ranks]', $rank_id, $userdata['user_id'], $userdata['username']);
		// Log actions MOD End	
	...
	else if( $mode == "delete" )
	{
		...
		if( $rank_id )
		{
			...
			// Log actions MOD Start
			log_action('delete[rank]', $rank_id, $userdata['user_id'], $userdata['username']);
			// Log actions MOD End
	...
	else
	{
		...
		//
		$template->set_filenames(array(
			"body" => "service/ranks_list_body.tpl")
		);
