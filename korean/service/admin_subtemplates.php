...
if ($mode == 'edit')
{
	...
	else if ($submit)
	{
		...
		$template->assign_vars(array(
			...
			'MESSAGE_TEXT'	=> sprintf( $lang['subtpl_click_return'], '<a href="' . append_sid("admin_subtemplates.$phpEx") . '" class="gen">', '</a>' ),
			)
		);
	}
	else
	{
		// screen
		$template->set_filenames(array(
			"body" => "service/admin_subtpl_edit_body.tpl")
		);
...
if ($mode == 'stpl')
{
	// screen
	$template->set_filenames(array(
		"body" => "service/admin_subtpl_list_body.tpl")
	);
...
if ($mode == 'style')
{
	// screen
	$template->set_filenames(array(
		"body" => "service/admin_subtpl_styles_body.tpl")
	);
