...
{
	global $db, $phpbb_root_path, $__stats_config, $board_config, $phpEx;
	...
	include($phpbb_root_path . trim($__stats_config['modules_dir']) . '/' . $module_dir . '/lang_' . $board_config['default_lang'] . '/lang.' . $phpEx);

	$ret_array['name'] = $lang['module_name'];
