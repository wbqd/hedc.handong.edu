...
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$yim, &$website, &$location, &$location2, &$occupation, &$interests, &$signature, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$gender, &$birthday, &$realname, &$zipcode1, &$zipcode2, &$jumin1, &$jumin2, &$mphone1, &$mphone2, &$mphone3, &$hphone1, &$hphone2, &$hphone3, &$remark1, &$remark2, &$remark3, &$remark4, &$remark5, &$remark6, &$remark7, &$remark8, &$remark9, &$remark10, &$remark11, &$remark12, &$remark13, &$remark14, &$remark15, &$remark16, &$remark17, &$remark18, &$remark19, &$remark20)
{
	...
	$params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'yim', 'website', 'location', 'location2', 'occupation', 'interests', 'signature', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'gender', 'birthday', 'realname', 'zipcode1', 'zipcode2', 'jumin1', 'jumin2', 'mphone1', 'mphone2', 'mphone3', 'hphone1', 'hphone2', 'hphone3', 'remark1', 'remark2', 'remark3', 'remark4', 'remark5', 'remark6', 'remark7', 'remark8', 'remark9', 'remark10', 'remark11', 'remark12', 'remark13', 'remark14', 'remark15', 'remark16', 'remark17', 'remark18', 'remark19', 'remark20');
