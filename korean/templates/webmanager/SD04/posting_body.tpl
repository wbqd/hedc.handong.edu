...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_AUTHOR}</span></td>
	...
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_EMAIL}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td width="80%" valign="top"><span class="genmed"> 
	...
	<tr>
		<td colspan="3" valign="top">
						<textarea name="message" rows="20" cols="87" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
		</td>
	</tr>
	<tr> 
...
<table width="95%" cellspacing="2" border="0" align="center" cellpadding="2">
  ...
  <input type="hidden" name="afterPostMsg" value="GuestBook-message stored">
