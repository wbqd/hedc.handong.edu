...
function checkForm() {
	...
	if (document.post.subject.value.length < 1) {
		formErrors += "모임명을 입력해주세요." + "\n";
	}
	if (document.post.remark1.value.length < 1) {
		formErrors += "책임연구자를 입력해주세요." + "\n";
	}
...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30">&nbsp;<span class=menuTitle>모임명</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td width="80%"><span class="genmed"> 
			<input type="text" name="subject" size="50" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>책임연구자</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark2" size="40" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark3" size="20" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: OOO-OOOO-OOOO</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="30" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: hedc@handong.edu</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>연구분야</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark5" size="50" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>연구주제</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark6" size="84" maxlength="100" class="formstyle4" value="{REMARK6}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>참여연구자</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark7" size="50" maxlength="100" class="formstyle4" value="{REMARK7}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 홍길동, 김영희, 김철수</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>기타/요청사항</span></td>
