...
<table width="95%" cellspacing="0" cellpadding="2" border="0">
	...
	<tr> 
		<td width="18%" height="30">&nbsp;<span class=menuTitle>모임명</span></td>
	...
	<tr> 
		...
		<td width="3" valign="middle"><span class=menuBorder>|</span></td>
		<td><span class="genmed">{postrow.REMARK6}</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="top" height="100">&nbsp;<span class=menuTitle>기타/요청사항</span></td>
