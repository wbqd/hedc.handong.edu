...
function checkForm() {
	...
	if (document.post.subject.value.length < 1) {
		formErrors += "제목을 입력해주세요." + "\n";
	}
	if (document.post.remark2.value.length < 1) {
		formErrors += "신청시작일을 입력해주세요." + "\n";
	}
	if (document.post.remark3.value.length < 1) {
		formErrors += "신청마감일을 입력해주세요." + "\n";
	}
	if (document.post.remark4.value.length < 1) {
		formErrors += "정원수를 입력해주세요." + "\n";
	}
	if (document.post.remark14.value.length < 1) {
		formErrors += "요약글을 입력해주세요." + "\n";
	}
...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	<tr> 
		<td colspan="3" height="2" >
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr> 
					<td height="2" bgcolor="#{THEME_COLOR_30}"></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr> 
		<td width="20%" height="30">&nbsp;<span class=menuTitle>{MENU_LANG_TITLE}</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td width="80%"><span class="genmed"> 
			<input type="text" name="subject" size="83" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>워크샵 분류</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="text" name="remark1" size="14" maxlength="10" class="formstyle4" value="{REMARK1}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: GT워크샵 or 한동교수아카데미 or 신임교수모임 or 선물공새 or GSA워크샵 or 기타</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>신청시작일</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark2" size="14" maxlength="10" class="formstyle4" value="{REMARK2}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 2014/01/05</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>신청마감일</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark3" size="14" maxlength="10" class="formstyle4" value="{REMARK3}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 2014/01/25</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>정원수</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="5" maxlength="5" class="formstyle4" value="{REMARK4}" />&nbsp;명&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<!--tr> 
		<td height="30">&nbsp;<span class=menuTitle>진행상태</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark5" value="접수중" checked style="border-width : 0px;">접수중&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark5" value="마감 임박" style="border-width : 0px;">마감임박&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark5" value="마감" style="border-width : 0px;">마감&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>신청하기 게시판 URL</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark6" size="80" maxlength="100" class="formstyle4" value="{REMARK6}" /><br><span style="color: #aaaaaa;">Ex: https://hedc.handong.edu:40006/korean/viewforum.php?f=22 or viewforum.php?f=22</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>요약글</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><span style="color: #aaaaaa;">목록에 표시될 간단한 설명글을 2~3문장정도 입력해 주세요.</span><br><textarea name="remark14" rows="3" cols="87" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{REMARK14}</textarea></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
