...
<table width="95%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td width="10%" height="29">&nbsp;<span class=menuTitle>{MENU_LANG_BANNERNAME}</span></td>
	...
	<tr>
		<td width="10%" height="29">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="1" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="90%" colspan="4"><span class="genmed">http://{postrow.REMARK1}</span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
