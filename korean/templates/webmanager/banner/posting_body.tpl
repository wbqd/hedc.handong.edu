...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30" valign="middle">&nbsp;<span class=menuTitle>{MENU_LANG_AUTHOR}</span></td>
		<td width="1" valign="middle"><span class=menuBorder>|</span></td>
		<td width="80%" valign="middle"><span class="genmed"><input type="text" class="formstyle4" name="username" size="25" maxlength="25" value="{USERNAME}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td width="20%" height="30" valign="middle">&nbsp;<span class=menuTitle>{MENU_LANG_ID}</span></td>
		<td width="1" valign="middle"><span class=menuBorder>|</span></td>
		<td width="80%" valign="middle"><span class="genmed"><input type="text"  class="formstyle4" name="username" maxlength="25" size="25" value="{USERNAME}" />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=180,resizable=yes,WIDTH=400');return false;" /></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<!-- END switch_privmsg -->
	<tr> 
		<td width="20%" height="30" valign="middle">&nbsp;<span class=menuTitle>{MENU_LANG_BANNERNAME}</span></td>
		<td width="1" valign="middle"><span class=menuBorder>|</span></td>
		<td width="80%" valign="middle"><span class="genmed"> 
	...
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> http://<input type="text" name="remark1" size="40" maxlength="100" class="formstyle4" value="{REMARK1}" />&nbsp;			
			<select name="remark2" size="1">				
				<option value="_blank">_blank ({MENU_LANG_NEW_WINDOW})
				<option value="_self">_self  ({MENU_LANG_CURRENT_WINDOW})
			</select></span></td>
	</tr>
