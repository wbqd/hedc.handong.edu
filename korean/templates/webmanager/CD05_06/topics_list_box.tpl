...
<tr bgcolor="#Fafafa">
	...
	<td width="22%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학부</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="16%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>연락처</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="30%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>E-mail</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#{THEME_COLOR_4}';" onMouseOut=this.style.backgroundColor="white">
	...
	<td></td>
	<td align="center"><span class="genmed"><a href="mailto:{topics_list_box.row.REMARK3}">{topics_list_box.row.REMARK3}</a></span></td>
	<td></td>
