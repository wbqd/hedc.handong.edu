...
<table width="95%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td width="90%" colspan="4"><span class="genmed"><b>{postrow.POST_SUBJECT}</b></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="3" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="54%"><span class="genmed"><b>{postrow.U_PROFILE_HEAD}{postrow.POSTER_NAME}{postrow.U_PROFILE_TAIL}</b></td>
