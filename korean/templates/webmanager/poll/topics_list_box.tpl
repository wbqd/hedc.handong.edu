...
<tr>
	<td colspan="8" height="1" bgcolor="#{THEME_COLOR_30}"></td>
</tr>
<tr bgcolor="#Fafafa">
	<td width="62%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>{MENU_LANG_TITLE}</span></td>
...
<!-- BEGIN topic -->
<tr> 
	<td height="27" nowrap="nowrap">&nbsp;<img src="{topics_list_box.row.TOPIC_FOLDER_IMG}" alt="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" title="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" />&nbsp;{topics_list_box.row.TOPIC_ATTACHMENT_IMG}{topics_list_box.row.TOPIC_TYPE}<a href="{topics_list_box.row.U_VIEW_TOPIC}" class="gen">{topics_list_box.row.TOPIC_TITLE_FULL}</a>&nbsp;{topics_list_box.row.NEW_IMG}</span></td>
	<td></td>
