...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr>
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_MESSAGETYPE}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td width="80%" valign="top"><span class="genmed"> 
		<!-- BEGIN switch_icon_checkbox -->
			...
			<tr>
				<td nowrap="nowrap">
					<span class="genmed">
						<!-- BEGIN cell -->
						<input type="radio" class="formstyle3" name="post_icon" value="{switch_icon_checkbox.row.cell.ICON_ID}"{switch_icon_checkbox.row.cell.ICON_CHECKED}>&nbsp;{switch_icon_checkbox.row.cell.ICON_IMG}&nbsp;&nbsp;
						<!-- END cell -->
					</span>
				</td>
			</tr>
