...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#{THEME_COLOR_4}';" onMouseOut=this.style.backgroundColor="white">
	<td height="27">&nbsp;<img src="{topics_list_box.row.TOPIC_FOLDER_IMG}" alt="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" title="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" />&nbsp;{topics_list_box.row.ICON}{topics_list_box.row.TOPIC_ATTACHMENT_IMG}<a href="{topics_list_box.row.U_VIEW_TOPIC}" class="gen">{topics_list_box.row.TOPIC_TITLE_FULL}</a>&nbsp;{topics_list_box.row.NEW_IMG}</span></td>
	<td></td>
