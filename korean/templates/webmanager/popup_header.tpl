...
a.calendar:hover	{ text-decoration: none; color : {T_BODY_HLINK}; }




/* This is the outline round the main vote tables */
.voteline	{ background-color: #F3F3F3; border: 1px #E6E6E6 solid; }
...
th	{
	...
	background-color: {T_TD_COLOR2}; height: 25px;
...
a.link:hover	{ color: #B4B4B4; text-decoration: none; }
...
.cattitle		{ font-weight: bold; font-size: {T_FONTSIZE3}px ; letter-spacing: 1px; color : {T_BODY_TEXT}}
...
/* Form style */
.formstyle { border-color: {T_TD_COLOR3}; border-style: solid;	border-width: 1px
}
...
/* Form style4 */
.formstyle4 { border-color: #9A9A9A; border-style: solid;	border-width: 1px
}
...
<body {MOUSE_PROTECTION} {TOP_LEFT_MARGIN} bgcolor="{T_BODY_BGCOLOR}" text="{T_BODY_TEXT}" link="{T_BODY_LINK}" vlink="{T_BODY_VLINK}">
