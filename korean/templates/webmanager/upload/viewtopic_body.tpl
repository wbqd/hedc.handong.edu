...
<!-- BEGIN switch_attach -->
	<tr>
		...
		<td colspan="4"><span class="genmed">{postrow.FILENAME_ONLY}</span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
<!-- END switch_attach -->
	<tr>
		<td nowrap="nowrap" height="29">&nbsp;<span class=menuTitle>{MENU_LANG_PATH}</span></td>
		<td width="1"><span class=menuBorder>|</span>&nbsp;</td>
		<td colspan="4"><span class="genmed">{postrow.FULL_IMG_PATH}<br>{postrow.THUMB_IMG_PATH}</span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
