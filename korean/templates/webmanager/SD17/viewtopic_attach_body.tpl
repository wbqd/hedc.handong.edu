...
<!-- BEGIN attach -->
	...
	<tr>
		...
		<td rowspan="4" align="center" width="10%" class="attachrow"><a href="{postrow.attach.attachrow.U_DOWNLOAD_LINK}" {postrow.attach.attachrow.TARGET_BLANK} class="genmed"><img src="templates/lab/images/save.gif" border="0"></a></td>
	</tr>
	<tr>
