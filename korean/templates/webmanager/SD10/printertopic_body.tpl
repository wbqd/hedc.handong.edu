			...
			<table width="100%" border="0" cellspacing="3" cellpadding="5">
				<tr>
					...
					<table border="0" cellspacing="0" cellpadding="1" bgcolor="#FFFFFF" style="border-width:1px; border-color:#{THEME_COLOR_30}; border-style:solid;">
						<tr>
							<td align="center" valign="middle">{postrow.THUMBNAIL_SRC_HEADER}<img src="{postrow.THUMBNAIL_ONLY}" width="{postrow.THUMB_WIDTH_90}" height="{postrow.THUMB_HEIGHT_90}" border="0">{postrow.THUMBNAIL_SRC_TAIL}</td>
						</tr>
					</table>
					</td>
					<td valign="top">
