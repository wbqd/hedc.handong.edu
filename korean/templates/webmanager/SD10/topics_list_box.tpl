...
<tr>
	...
	<tr bgcolor="#fafafa">
		<td height="30" colspan="2">&nbsp;&nbsp;&nbsp;<span class="genmed"><img src="templates/webmanager/images/ico_sq3.gif" border="0" align="absmiddle">&nbsp;<font color=#000000><b>{FORUM_NAME}</b></font></span>
		</td>
	</tr>
<tr>
	<td colspan="2" height="1" bgcolor="#{THEME_COLOR_30}"></td>
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" span class="genmed" style="line-height=180%">
		...
		<tr>
			...
			<td>
				{topics_list_box.row.REMARK11}				
			</td>
		</tr>
		<!-- END switch_remark11 -->
		<tr>
			<td valign="top" align="center"  height="5" colspan="2"></td>
		</tr>
		<tr>
		<td colspan="2">
...
<tr> 
	<td colspan="2" height="7" align="center" valign="middle"></td>
</tr>
<tr> 
