...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td colspan="3" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;<input type="button" tabindex="5" name="cancel" class="mainoption" value="{L_CANCEL}" OnClick="history.go(-1)"/>
		</td>
	</tr>
</table>
