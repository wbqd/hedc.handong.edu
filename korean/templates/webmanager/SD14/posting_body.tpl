...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td width="80%" valign="top"><span class="genmed"> 
			<input type="text" name="subject" size="65" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_STREAMING}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><span class="genmed"><font color="red">
					ex1) mms://www.ontoin.com/abc.wmv&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Speed : 128kbps
					<br>
					ex2) http://www.ontoin.com/abc1.mp3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title : Chapter 1
					</font></span></td>
				</tr>
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark6" size="40" maxlength="100" class="formstyle4" value="{REMARK6}" />&nbsp;&nbsp;<input type="text" name="remark7" size="18" maxlength="100" class="formstyle4" value="{REMARK7}" /></span></span>
					</td>
				</tr>
				<tr>
					<td height="5"></td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark8" size="40" maxlength="100" class="formstyle4" value="{REMARK8}" />&nbsp;&nbsp;<input type="text" name="remark9" size="18" maxlength="100" class="formstyle4" value="{REMARK9}" /></span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark10" size="40" maxlength="100" class="formstyle4" value="{REMARK10}" />&nbsp;&nbsp;<input type="text" name="remark11" size="18" maxlength="100" class="formstyle4" value="{REMARK11}" /></span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark12" size="40" maxlength="100" class="formstyle4" value="{REMARK12}" />&nbsp;&nbsp;<input type="text" name="remark13" size="18" maxlength="100" class="formstyle4" value="{REMARK13}" /></span></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark1" size="36" maxlength="100" class="formstyle4" value="{REMARK1}" />&nbsp;</span>
					</td>
				</tr>
				<tr>
					<td height="5"></td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark2" size="36" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark3" size="36" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark4" size="36" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark5" size="36" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
				</tr>
			</table>
		</td>
	</tr>
