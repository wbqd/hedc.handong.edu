...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>분류</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark1" value="일반" checked style="border-width : 0px;">일반&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark1" value="필독" style="border-width : 0px;">필독&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark1" value="공지" style="border-width : 0px;">공지&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark1" value="서식" style="border-width : 0px;">서식</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
