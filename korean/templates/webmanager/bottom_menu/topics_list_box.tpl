...
<tr bgcolor="#Fafafa">
	<td width="64%" align="center" nowrap="nowrap" height="30"><span class=menuTitle>{MENU_LANG_TITLE}</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="17%" align="center" nowrap="nowrap"><span class=menuTitle>{MENU_LANG_AUTHOR}</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#f5f5f5';" onMouseOut=this.style.backgroundColor="white">
	<td height="27">&nbsp;<img src="{topics_list_box.row.TOPIC_FOLDER_IMG}" alt="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" title="{topics_list_box.row.L_TOPIC_FOLDER_ALT}" />&nbsp;{topics_list_box.row.TOPIC_ATTACHMENT_IMG}<a href="{topics_list_box.row.U_EDIT_TOPIC}" class="gen">{topics_list_box.row.TOPIC_TITLE_FULL}</a>&nbsp;{topics_list_box.row.NEW_IMG}</span></td>
	<td></td>
