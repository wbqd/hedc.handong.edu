...
<table align="center" cellpadding="0" cellspacing="1" border="0" width="95%" class="forumline">
<tr>
	<td align="center" class="catHead" colspan="{_calendar_box.SPAN_ALL}" width="100%">
		...
		<tr>
			...
			<td width="100%" align="center">{_calendar_box.S_MONTH}{_calendar_box.S_YEAR}</td>
...
<tr>
	<td width="100%"></td>
	<td align="right" nowrap="nowrap"><span class="mainmenu"><a href="#" onClick="hdr_toggle('calendar_display','calendar_open_close', '{DOWN_ARROW}', '{UP_ARROW}'); return false;" class="genmed"><img src="{TOGGLE_ICON}" id="calendar_open_close" hspace="2" border="0" />{_calendar_box.L_CALENDAR_TXT}</a>&nbsp;</span></td>
</tr>
<tbody id="calendar_display" style="display:{TOGGLE_STATUS}">
<tr height="2"><td></td></tr>
<tr><td colspan="2">
	<table align="center" cellpadding="0" cellspacing="1" border="0" width="99%" class="forumline">
	<tr>
...
<!-- BEGIN switch_full_month -->
<tr>
	<td class="catbottom" align="center" colspan="{_calendar_box.SPAN_ALL}" width="100%">&nbsp;</td>	
</tr>
