...
<form method="post" action="{S_DBUTILS_ACTION}"><table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		...
		<td class="row2"><input class="formstyle3" type="radio" name="backup_type" value="full" checked /></td>
	</tr>
	<tr>
		<td class="row1">{L_STRUCTURE_BACKUP}</td>
		<td class="row1"><input class="formstyle3" type="radio" name="backup_type" value="structure" /></td>
	</tr>
	<tr>
		<td class="row2">{L_DATA_BACKUP}</td>
		<td class="row2"><input class="formstyle3" type="radio" name="backup_type" value="data" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row1">{L_NO} <input class="formstyle3" type="radio" name="gzipcompress" value="0" checked /> &nbsp;{L_YES} <input class="formstyle3" type="radio" name="gzipcompress" value="1" /></td>
	</tr>
	<tr>
