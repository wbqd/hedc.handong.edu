...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		...
		<td class="row2" align="left" width="50%"><span class="gen"><input class="formstyle3" type="radio" name="active" value="1" {ACTIVE_CHECKED_YES}>&nbsp;{L_YES}&nbsp;&nbsp;<input class="formstyle3" type="radio" name="active" value="0" {ACTIVE_CHECKED_NO}>&nbsp;{L_NO}</span></td>
	</tr>		
	<tr>
