...
function checkForm() {
	...
	if (document.post.remark1.value.length < 1) {
		formErrors += "접수기간(시작일)을 입력해주세요." + "\n";
	}
	if (document.post.remark2.value.length < 1) {
		formErrors += "접수기간(마감일)을 입력해주세요." + "\n";
	}
...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30">&nbsp;<span class=menuTitle>제목</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td width="80%"><span class="genmed"><input type="text" name="subject" size="83" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>접수기간</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed">시작일 : <input type="text" name="remark1" size="14" maxlength="10" class="formstyle4" value="{REMARK1}" />&nbsp;&nbsp;마감일 : <input type="text" name="remark2" size="14" maxlength="10" class="formstyle4" value="{REMARK2}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 2014/01/05</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark3" value="접수중" checked style="border-width : 0px;">접수중&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark3" value="마감 임박" style="border-width : 0px;">마감임박&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark3" value="마감" style="border-width : 0px;">마감&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>참여하기 게시판 URL</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="80" maxlength="100" class="formstyle4" value="{REMARK4}" /><br><span style="color: #aaaaaa;">Ex: viewforum.php?f=22</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>결과보기 게시판 URL</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark5" size="80" maxlength="100" class="formstyle4" value="{REMARK5}" /><br><span style="color: #aaaaaa;">Ex: http://ibook.handong.edu</span></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>공모전 간단 요약글</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
