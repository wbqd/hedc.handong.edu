...
<!-- BEGIN topic -->
	...
	<tr>
		<td width="27%" align="center" valign="top">
			...
			<tr>
				<td align="center" valign="middle"><a href="{topics_list_box.row.U_VIEW_TOPIC}" class="topictitle"><img src="{topics_list_box.row.THUMBNAIL_ONLY}" width="{topics_list_box.row.THUMB_WIDTH_100}" height="{topics_list_box.row.THUMB_HEIGHT_100}" border="0"></a></td>
			</tr>		
			</table>
		</td>
		<td valign="top">
		<font color="#ADADAD">URL : <a href="{topics_list_box.row.REMARK1}" class="span" style="color : #ADADAD;">{topics_list_box.row.REMARK1}({topics_list_box.row.REMARK2})</a></font><br><br>
