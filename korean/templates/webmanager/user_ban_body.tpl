<span class="cattitle">English HD 신청 금지 목록</span>
<table width="90%" cellpadding="2" cellspacing="1" border="0">
	...
	<!-- END ban_list_row -->
	<tr bgcolor="#e5eecc">
		<td colspan="5" align="center"><strong>Add a new user</strong></td>
	</tr>
...
function chkAddForm() {
	with (document.add_ban_form) {
		...
		if (confirm("사용자 '" + ban_username.value + "'(을)를 " + ban_until.value + "까지 English HD 신청을 금지하도록 하시겠습니까?")) {
		    return true;
		} else {
		    return false;
		}
