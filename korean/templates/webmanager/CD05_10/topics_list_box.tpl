...
<tr bgcolor="#Fafafa">
	<td width="17%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>이름</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="15%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학부</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="14%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학번</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="17%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>연락처</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="24%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>E-mail</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#{THEME_COLOR_4}';" onMouseOut=this.style.backgroundColor="white">
	...
	<td></td>
	<td align="center"><a href="mailto:{topics_list_box.row.REMARK6}" class="genmed">{topics_list_box.row.REMARK6}</a></td>
	<td></td>
