...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark7" size="5" maxlength="5" class="formstyle4" value="{REMARK7}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 3.0</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>생년월일<br><span style="color: #aaaaaa;">(학습유형검사시 필요)</span></span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark8" size="10" maxlength="10" class="formstyle4" value="{REMARK8}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 1985/01/05</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle style="line-height:180%;">학습에 어려움을<br>&nbsp;겪는 부분 서술</span></td>
