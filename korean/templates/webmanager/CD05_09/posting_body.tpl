...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>희망 컨설팅 일시</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark7" size="30" maxlength="100" class="formstyle4" value="{REMARK7}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 2014년 05월 09일 오전 11:30</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark8" value="E-mail" checked style="border-width : 0px;">E-mail&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark8" value="방문" style="border-width : 0px;">방문&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle style="line-height:180%;">도움 받고 싶은 내용</span></td>
