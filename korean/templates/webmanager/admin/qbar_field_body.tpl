...
<tr>
	<td class="row2"><span class="gen">{L_ICON2}</span><span class="gensmall"><br />{L_ICON2_EXPLAIN}</span></td>
	<td class="row1"><span class="gen"><input type="text" size="50" name="icon2" value="{ICON2}" /><br />{ICON2_TR}</span></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row1"><span class="gen"><input type="text" name="alternate" value="{ALTERNATE}" /><br />{ALTERNATE_TR}</span></td>
</tr>
<tr>
