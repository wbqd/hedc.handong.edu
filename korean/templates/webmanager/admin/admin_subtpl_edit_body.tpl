...
<tr>
	<td>
		<span class="nav">
			...
			&nbsp>&nbsp;<a href="{U_MAIN_STYLE}" class="nav">{MAIN_STYLE}</a>
		</span>
	</td>
</tr>
</table>
...
<tr>
	<th class="thTop" colspan="2">{L_SUBTEMPLATE_TITLE}</th>
</tr>
<tr>
...
<!-- END boardrow -->
<tr>
	<td class="catBottom" align="center" colspan="{MAX_SPAN_FULL}">
		<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption">
		<input type="submit" name="cancel" value="{L_CANCEL}" class="mainoption">
	</td>
</tr>
