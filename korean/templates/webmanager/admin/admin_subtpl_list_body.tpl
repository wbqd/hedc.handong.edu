<br>
<b><span class="gen"><font color="#754C24">{L_SUBTEMPLATE_TITLE}</font></span></b>
<br><span class="gen">{L_SUBTEMPLATE_EXPLAIN}</span><br><br>
...
<tr>
	<td>
		<span class="nav">
			<a href="{U_CHOOSE_MAIN_STYLE}" class="nav">{L_MAIN_STYLE}</a>
			&nbsp>&nbsp;{MAIN_STYLE}
		</span>
	</td>
</tr>
...
<tr>
	...
	<th class="thTop">{L_DIR}</th>
	<th class="thTop">{L_HEAD_STYLESHEET}</th>
	<th class="thTop">{L_IMAGEFILE}</th>
...
<table cellspacing="1" width="100%" cellpadding="4" border="0" align="center" class="forumline">
<tr>
	<th class="thCornerL" colspan="{MAX_SPAN}">{L_FORUM}</th>
	<th class="thTop" colspan="{TPL_SPAN}">{L_TEMPLATE}</th>
</tr>
<!-- BEGIN boardrow -->
<tr>
	<!-- BEGIN inc -->
...
<!-- END boardrow -->
<tr>
	<td class="catBottom" align="center" colspan="{MAX_SPAN_FULL}">&nbsp;</td>
</tr>
</table>
<br>