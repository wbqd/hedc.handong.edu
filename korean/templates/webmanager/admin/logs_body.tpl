...
<br>
<b><span class="gen"><font color="#754C24">{L_LOG_ACTIONS_TITLE}</font></span></b>
<br><span class="gen">{L_LOG_ACTION_EXPLAIN}</span><br><br>
...
<tr>
		...
		<td class="row2"><center>{record_row.TOPIC}</center></td>
