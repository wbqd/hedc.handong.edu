...
function checkForm() {
	...
	if (document.post.subject.value.length < 1) {
		formErrors += "신청자명을 입력해주세요." + "\n\n";
	}
	if (document.post.remark3.value.length < 1) {
		formErrors += "휴대폰 번호를 입력해주세요." + "\n\n";
	}
...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" valign="middle">&nbsp;<span class=menuTitle>신청자</span></td>
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>소&nbsp;&nbsp;&nbsp;속</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>Office 전화</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
		...
		<td valign="top"><span class="genmed">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td>
						<span class="genmed"> 
						<textarea name="message" rows="20" cols="68" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
						</span>
					</td>
				</tr>
			</table>
