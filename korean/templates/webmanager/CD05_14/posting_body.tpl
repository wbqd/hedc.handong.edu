...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"><input type="text" name="remark2" size="30" maxlength="100" class="formstyle4" value="{REMARK2}">&nbsp;<font color="#ADADAD">Ex : PM 01:30-02:00</font>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
