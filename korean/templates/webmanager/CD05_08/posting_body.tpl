...
<table border="0" cellpadding="3" cellspacing="0" width="95%" style="line-height:180%;">
	<tr> 
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>소속</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark1" size="40" maxlength="100" class="formstyle4" value="{REMARK1}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark2" size="20" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: OOO-OOOO-OOOO</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>수업촬영 신청 일시</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark3" size="40" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 2014년 05월 09일 오전 11:30</span><br>*HEDC가 의뢰하는 촬영기사의 일정에 따라 조정이 필요할 수 있습니다.&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>교과목명</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="40" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>수업장소</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark5" size="40" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>교과목분류</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark6" value="전공필수" checked style="border-width : 0px;">전공필수&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="remark6" value="전공선택" style="border-width : 0px;">전공선택&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="remark6" value="교양필수" style="border-width : 0px;">교양필수&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="remark6" value="교양선택" style="border-width : 0px;">교양선택&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>학생수</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark7" size="4" maxlength="6" class="formstyle4" value="{REMARK7}" />&nbsp;&nbsp;명&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>대상학년</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark8" size="4" maxlength="10" class="formstyle4" value="{REMARK8}" />&nbsp;&nbsp;학년&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>분석방법 선택</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark9" value="HEDC 전문 컨설턴트 서면 분석" checked style="border-width : 0px;">HEDC 전문 컨설턴트 서면 분석&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="remark9" value="1:1 분석" style="border-width : 0px;">1:1 분석&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>개선하고 싶은 사항<br>&nbsp;& 기타 요청사항</span></td>
