...
<tr height="27">
	<td width="24%" align="center" nowrap="nowrap"><span class=menuTitle>날&nbsp;&nbsp;&nbsp;짜</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="24%" align="center" nowrap="nowrap"><span class=menuTitle>시간대</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="24%" align="center" nowrap="nowrap"><span class=menuTitle>튜&nbsp;&nbsp;&nbsp;터</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="24%" align="center" nowrap="nowrap" colspan="2"><span class=menuTitle>신청현황</span></td>
	<!--td width="1"><span class=menuBorder>|</span></td>
...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#{THEME_COLOR_4}';" onMouseOut=this.style.backgroundColor="white" height="27">
	<td align="center"><span class="genmed">{topics_list_box.row.REMARK1}<span class="genmed"></span></td>
	<td></td>
