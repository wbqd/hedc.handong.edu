...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark1" size="57" maxlength="130" class="formstyle4" value="{REMARK1}" />
			<select name="remark2" size="1">
				<option value="_self">현재창</option>
				<option value="_blank">새창</option>
			</select><br><font color="#ADADAD">Ex : http://hedc.handong.edu/korean/viewforum.php?f=22 or viewforum.php?f=22</font>
			</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
	...
	<tr> 
		<td valign="top">&nbsp;<span class=menuTitle>내용</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr> 
					<td>
						<span class="genmed"> 
						<textarea name="message" rows="10" cols="67" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
						</span>
					</td>
				</tr>
			</table>
	...
	<tr> 
		<td width="20%" height="30">&nbsp;<span class=menuTitle>{MENU_LANG_PASS}</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td width="80%"><input type="password" class="formstyle4" style="width200px"  name="remark15" size="4" maxlength="4" value="" />
		</td>
	</tr>
	<!-- END switch_password -->
	<tr>
