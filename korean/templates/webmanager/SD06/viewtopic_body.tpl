...
<!-- END switch_user_logged_in -->
	...
	<tr> 
		<td width="18%" height="30">&nbsp;<span class=menuTitle>{MENU_LANG_NAME}</span></td>
...
<!-- BEGIN switch_remark4 -->
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="3" valign="middle"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><a href="http://{postrow.REMARK4}">http://{postrow.REMARK4}</a></span></td>
	</tr>
<!-- END switch_remark4 -->
