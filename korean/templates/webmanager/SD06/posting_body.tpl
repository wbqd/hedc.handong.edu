...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_NAME}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td width="80%" valign="top"><span class="genmed"> 
			<input type="text" name="subject" size="30" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_ADDRESS}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark1" size="50" maxlength="100" class="formstyle4" value="{REMARK1}" /></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			http://<input type="text" name="remark4" size="34" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_EMAIL}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_TEL}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_FAX}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark3" size="20" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td valign="top"><span class="genmed">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td>
						<span class="genmed"> 
						<textarea name="message" rows="5" cols="68" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
						</span>
					</td>
				</tr>
			</table>
