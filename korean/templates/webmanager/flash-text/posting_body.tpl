...
function delimiterDetect(textbox) {
	...
	if(textbox) {		
		if("text" == textbox.type) {				
			if (textbox.value.indexOf('กา') >= 0) {
				return "{BANNED_CHAR}: กา" + "\n";
			}
		}		
	}	
	return "";
...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
		<tr> 
		<td align="left" valign="middle" width="100%"><b><span class="gen"><font color="#754C24">{FORUM_NAME}</font></span></b><br></td>
		</tr>
</table>
...
<table border="0" cellpadding="6" cellspacing="0" width="95%">
	<tr> 
		<td colspan="3" height="1" bgcolor="#3E98D0"></td>
	</tr>
	<!-- BEGIN switch_username_select -->
	<tr> 
		<td width="20%" height="30">&nbsp;<img src="templates/webmanager/images/board/posting.gif"><img src="templates/webmanager/images/board/author.gif"></td>
		<td width="1"><img src="templates/webmanager/images/board/posting-ver-line.gif"></td>
	...
	<tr> 
		<td width="20%" height="30">&nbsp;<img src="templates/webmanager/images/board/posting.gif"><img src="templates/webmanager/images/board/to.gif"></td>
		<td width="1"><img src="templates/webmanager/images/board/posting-ver-line.gif"></td>
	...
	<!-- END switch_privmsg -->
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<img src="templates/webmanager/images/board/posting.gif"><img src="templates/webmanager/images/board/title.gif"></td>
		<td width="1" valign="top"><img src="templates/webmanager/images/board/posting-ver-line.gif"></td>
	...
	<tr> 
		...
		<table border="0" cellpadding="0" cellspacing="0" valign="top"><tr>
			<Td valign="top">&nbsp;<img src="templates/webmanager/images/board/posting.gif" valign="top"></td>
			<td valign="top"><img src="templates/webmanager/images/admin/coordinateflashtext.gif" valign="top"></td>
		</tr></table></td>
		<td width="1" valign="top"><img src="templates/webmanager/images/board/posting-ver-line.gif"></td>
		<td width="80%" valign="top"><span class="genmed">X : <input type="text" name="remark1" size="5" maxlength="5" class="post" value="{REMARK1}" />&nbsp;&nbsp;&nbsp;Y : <input type="text" name="remark2" size="5" maxlength="5" class="post" value="{REMARK2}" />&nbsp;&nbsp;Ex)&nbsp;X : 200&nbsp;&nbsp;&nbsp;Y : 400</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1" bgcolor="#DADADA"></td>
	</tr>
	<tr>
		<td colspan="3" valign="top">&nbsp;<img src="templates/webmanager/images/board/posting.gif"><img src="templates/webmanager/images/board/content.gif"><span class="genmed">
	...
	<tr> 
		<td height="30">&nbsp;<img src="templates/webmanager/images/board/posting.gif"><img src="templates/webmanager/images/board/pass.gif"></td>
		<td width="1"><img src="templates/webmanager/images/board/posting-ver-line.gif"></td>
	...
	<tr> 
		<td colspan="3" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" />&nbsp;<input type="reset" tabindex="5" name="cancel" class="mainoption" value="{L_CANCEL}" OnClick="namosw_goto('backward')"/>
