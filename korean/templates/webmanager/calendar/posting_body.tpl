...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td width="80%"><span class="genmed"><input type="text" class="post" name="username" size="25" maxlength="25" value="{USERNAME}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="80%" valign="top"><span class="genmed"> 
			<input type="text" name="subject" size="68" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span><br><span class="gen">{S_TYPE_TOGGLE}</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td width="20%" height="30" valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_EVENT}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
	    <td width="80%" valign="top"><span class="genmed">
				...
				<tr>
					...
					<td valign="top">
						<table cellpadding="2" cellspacing="0" width="100%" border="0">
							<tr>
								<td align="right" nowrap="nowrap"><span class="gen">{L_START}&nbsp;:</span></td>
								<td align="left" width="100%">
								<span class="genmed">{S_CALENDAR_YEAR}{S_CALENDAR_MONTH}{S_CALENDAR_DAY}&nbsp;
								<input type=button value="{L_TODAY}"  class=liteoption  onClick="document.post.topic_calendar_day.value={TODAY_DAY};document.post.topic_calendar_month.value={TODAY_MONTH};document.post.topic_calendar_year.value={TODAY_YEAR};"/>
								</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="right" valign="top" nowrap="nowrap"><span class="gen">{L_CALENDAR_DURATION}&nbsp;:</span></td>
