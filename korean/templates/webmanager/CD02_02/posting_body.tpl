...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="15%" height="30">&nbsp;<span class=menuTitle>{MENU_LANG_TITLE}</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td width="85%"><span class="genmed"><input type="text" name="subject" size="82" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="text" name="remark1" size="20" maxlength="100" class="formstyle4" value="{REMARK1}" /></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="20" maxlength="20" class="formstyle4" value="{REMARK4}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: OOO-OOOO-OOOO</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark5" size="30" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: hedc@handong.edu</span>&nbsp;</span></td>
	</tr>	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr> 
	...
	<tr>
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>요약</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td><span class="genmed" valign="top"><textarea name="message" rows="20" cols="87" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea></td>
	</tr>
	<tr> 
