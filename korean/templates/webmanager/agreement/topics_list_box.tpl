...
<tr>
	<td colspan="6" height="1" bgcolor="#{THEME_COLOR_30}"></td>
</tr>
<tr bgcolor="#fafafa">
...
<!-- BEGIN no_topics -->
<tr> 
	<td colspan="6" height="29" align="center" valign="middle"><span class="genmed">{topics_list_box.row.L_NO_TOPICS}</span></td>
</tr>
<tr>
	<td colspan="6" height="1" bgcolor="#DADADA"></td>
</tr>
