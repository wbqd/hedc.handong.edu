...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="15%"  valign="top">&nbsp;<span class=menuTitle>{MENU_LANG_TITLE}</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td width="85%" valign="top"><span class="genmed"> 
			<input type="text" name="subject" size="100" maxlength="130" class="formstyle4" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
		...
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark1" size="60" maxlength="100" class="formstyle4" value="{REMARK1}" />&nbsp;</span>
					</td>
				</tr>
				<tr>
					<td height="3"></td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark2" size="60" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;</span>
					</td>
				</tr>
				<tr>
					<td height="3"></td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark3" size="60" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="3">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark4" size="60" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="3"></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark5" size="60" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
				</tr>
				<!--tr>
					<td><span class="genmed"><input type="text" name="remark8" size="60" maxlength="100" class="formstyle4" value="{REMARK8}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark9" size="60" maxlength="100" class="formstyle4" value="{REMARK9}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark10" size="60" maxlength="100" class="formstyle4" value="{REMARK10}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark11" size="60" maxlength="100" class="formstyle4" value="{REMARK11}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark12" size="60" maxlength="100" class="formstyle4" value="{REMARK12}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td><span class="genmed"><input type="text" name="remark13" size="60" maxlength="100" class="formstyle4" value="{REMARK13}" />&nbsp;</span></td>
				</tr-->
			</table>
		</td>
	</tr>
	...
	<tr> 
		<td valign="top">&nbsp;<span class=menuTitle>URL</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark6" size="100" maxlength="100" class="formstyle4" value="{REMARK6}" />
			<select name="remark7" size="1">
				<option value="_blank">새창</option>
				<option value="_self">현재창</option>
			</select><br><font color="#ADADAD">Ex : http://hedc.handong.edu or viewforum.php?f=22</font>
			</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
	...
	<tr> 
		...
		<td><span class="genmed"><span style="color: #aaaaaa;">목록에 표시될 간단한 설명글을 2~3문장정도 입력해 주세요.</span><br><textarea name="remark14" rows="3" cols="98" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{REMARK14}</textarea></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
