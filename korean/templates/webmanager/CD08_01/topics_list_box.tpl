		...
		<table border="0" cellspacing="0" cellpadding="1" bgcolor="#FFFFFF" style="border-width:1px; border-color:#{THEME_COLOR_30}; border-style:solid;">
			<tr>
				<td align="center" valign="middle">
					<a href="{topics_list_box.row.REMARK6}" target="{topics_list_box.row.REMARK7}" class="topictitle"><img src="{topics_list_box.row.THUMBNAIL_ONLY}" width="{topics_list_box.row.THUMB_WIDTH_100}" height="{topics_list_box.row.THUMB_HEIGHT_100}" border="0"></a></td>
			</tr>		
		</table>
	</td>
	<td align="left" valign="top">
	<table border="0" cellpadding="1" cellspacing="0" width="100%" span class="genmed" style="line-height:180%">
		<tr>
			<td height="22" colspan="2" ><a href="{topics_list_box.row.U_VIEW_TOPIC}" class="gen" style="color:#000000; font-weight: bold; font-size:13px;">{topics_list_box.row.TOPIC_TITLE_FULL}</a></span></td>
		</tr>
		<tr>
			<td height="10" colspan="2" ></td>
		</tr>
...
<tr> 
	<td colspan="2" height="1" align="center" valign="middle" bgcolor="#eaeaea"></td>
</tr>
<!-- END topic -->
<!-- BEGIN no_topics -->
<tr> 
