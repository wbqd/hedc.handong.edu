...
function checkForm() {
	...
	if (document.post.remark8.value.length < 1) {
		formErrors += "이수과목 성적을 입력해주세요." + "\n";
	}
	if (document.post.remark9.value.length < 1) {
		formErrors += "직전학기 평점을 입력해주세요." + "\n";
	}
	if (document.post.remark10.value.length < 1) {
		formErrors += "영어실력을 입력해주세요." + "\n";
	}
...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>이수 여부</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark7" value="이수" checked style="border-width : 0px;">이수&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark7" value="미이수" style="border-width : 0px;">미이수&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>이수 과목 성적</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="text" name="remark8" size="10" maxlength="10" class="formstyle4" value="{REMARK8}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: A+</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>직전학기 평점</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="text" name="remark9" size="10" maxlength="10" class="formstyle4" value="{REMARK9}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: 4.0</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>영어실력</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="text" name="remark10" size="50" maxlength="100" class="formstyle4" value="{REMARK10}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30">&nbsp;<span class=menuTitle>튜터링 경험</span></td>
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"><input type="radio" name="remark11" value="있다" checked style="border-width : 0px;">있다&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="remark11" value="없다" style="border-width : 0px;">없다&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td height="30" valign="top">&nbsp;<span class=menuTitle>지원 동기</span></td>
