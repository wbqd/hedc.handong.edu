...
<tr>
	<td colspan="14" height="1" bgcolor="#{THEME_COLOR_30}"></td>
</tr>
<tr bgcolor="#Fafafa">
	<td width="14%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>이름</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="18%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학부</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="12%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학번</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="10%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>이수 여부</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="11%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>직전학기 평점</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="18%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>연락처</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="12%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>{MENU_LANG_DATE}</span></td>
</tr>
	<tr>
...
<tr bgcolor="white" onMouseOver="this.style.backgroundColor='#{THEME_COLOR_4}';" onMouseOut=this.style.backgroundColor="white">
	...
	<td></td>
	<td align="center"><span class="genmed">{topics_list_box.row.REMARK5}</span></td>
	<td></td>
...
<!-- BEGIN no_topics -->
<tr> 
	<td colspan="14" height="30" align="center" valign="middle"><span class="genmed">{topics_list_box.row.L_NO_TOPICS}</span></td>
</tr>
	<tr>
		<td colspan="14" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
