		...
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark2" size="38" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;</span>
					</td>
				</tr>
				<tr>
					<td height="3"></td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark3" size="38" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark4" size="38" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark5" size="38" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark6" size="38" maxlength="100" class="formstyle4" value="{REMARK6}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark7" size="38" maxlength="100" class="formstyle4" value="{REMARK7}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark8" size="38" maxlength="100" class="formstyle4" value="{REMARK8}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark9" size="38" maxlength="100" class="formstyle4" value="{REMARK9}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark10" size="38" maxlength="100" class="formstyle4" value="{REMARK10}" />&nbsp;</span></td>
				</tr>
				<tr>
					<td height="5">
					</td>
				...
				<tr>
					<td>
						<span class="genmed"> 
						<input type="text" name="remark11" size="38" maxlength="100" class="formstyle4" value="{REMARK11}" />&nbsp;</span></td>
				</tr>
			</table>
		</td>
	</tr>
