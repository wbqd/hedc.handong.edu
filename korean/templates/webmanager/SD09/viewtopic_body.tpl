...
<table width="95%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td width="3" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="90%" colspan="4"><span class="genmed"><font color=#000000>{postrow.POST_DATE}</font></span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td width="10%" nowrap="nowrap" height="29">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="3" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="90%" colspan="4"><span class="genmed"><a href="http://{postrow.REMARK2}" target="_blank"><font color=#000000>http://{postrow.REMARK2}</font></a></span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
