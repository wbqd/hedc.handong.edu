...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" height="30" valign="middle">&nbsp;<span class=menuTitle>{MENU_LANG_TITLE}</span></td>
	...
	<tr> 
		<td height="30" valign="middle">&nbsp;<span class=menuTitle>{MENU_LANG_URL}</span></td>
		<td width="1" valign="middle"><span class=menuBorder>|</span></td>
		<td valign="middle"><span class="genmed"> 
			http://<input type="text" class="formstyle4"  name="remark2" size="62" maxlength="100" value="{REMARK2}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td valign="top" valign="top"><span class="genmed">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td>
						<span class="gen"> 
						<textarea name="message" rows="8" cols="68" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
						</span>
					</td>
				</tr>
			</table>
