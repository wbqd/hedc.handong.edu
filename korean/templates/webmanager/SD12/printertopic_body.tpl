...
<table width="95%" cellspacing="0" cellpadding="0" border="0">
	...
	<tr> 
		...
		<td width="3" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="50%"><span class="genmed">{postrow.U_PROFILE_HEAD}{postrow.POSTER_NAME}{postrow.U_PROFILE_TAIL}</td>
	...
	<tr>
		<td width="12%" nowrap="nowrap" height="29">&nbsp;<span class=menuTitle>{MENU_LANG_FILENAME}</span></td>
		<td width="3" valign="middle"><span class=menuBorder>|</span>&nbsp;</td>
		<td width="90%" colspan="4"><span class="genmed">{postrow.FILENAME_ONLY}{postrow.DOWNLOAD_COUNT}</span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
