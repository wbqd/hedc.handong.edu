			...
			<tr>
				<td class="row1" colspan="2"><span class="genmed">{L_ADD_POLL_EXPLAIN}</span></td>
	        </tr>
            <tr>
            ...
            <tr>
				...
				<td class="row2"><span class="genmed"><input type="text" name="poll_length" size="3" maxlength="3" class="post" value="{POLL_LENGTH}" /></span>&nbsp;<span class="gen"><b>{L_DAYS}</b></span> <span class="genmed">{L_POLL_LENGTH_EXPLAIN}</span></td>
			</tr>
