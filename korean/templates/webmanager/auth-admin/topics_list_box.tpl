...
<tr>
	<td colspan="10" height="1" bgcolor="#b3b3b3"></td>
</tr>
<tr bgcolor="#Fafafa">
	<td width="65%" align="center" nowrap="nowrap" height="30"><span class=menuTitle>{MENU_LANG_TITLE}</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="20%" align="center" nowrap="nowrap"><span class=menuTitle>{MENU_LANG_AUTHOR}</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="15%" align="center" nowrap="nowrap"><span class=menuTitle>{MENU_LANG_DATE}</span></td>
	<!-- BEGIN multi_selection -->
