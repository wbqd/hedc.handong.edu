...
<tr bgcolor="#Fafafa">
	<td width="13%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>성명</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="12%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학번</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="23%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>학부</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="10%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>상담방법</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="23%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>희망상담일시</span></td>
	<td width="1"><span class=menuBorder>|</span></td>
	<td width="14%" align="center" nowrap="nowrap" height="29"><span class=menuTitle>{MENU_LANG_DATE}</span></td>
	<!-- BEGIN multi_selection -->
