...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		<td width="20%" valign="middle">&nbsp;<span class=menuTitle>성&nbsp;&nbsp;&nbsp;명</span></td>
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>성&nbsp;&nbsp;&nbsp;별</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"><input type="radio" name="remark1" value="남" checked style="border-width : 0px;">남&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="remark1" value="여" style="border-width : 0px;">여&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>학&nbsp;&nbsp;&nbsp;번</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark2" size="20" maxlength="100" class="formstyle4" value="{REMARK2}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>학&nbsp;&nbsp;&nbsp;부</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed">
			<select name="remark3" size="1">
				<option value="국제어문학부" selected>국제어문학부</option>
				...
				<option value="산업정보디자인학부">산업정보디자인학부</option>
				<option value="상담심리사회복지학부">상담심리사회복지학부</option>
				<option value="전산전자공학부">전산전자공학부</option>
				<option value="글로벌리더십학부">글로벌리더십학부</option>
				<option value="법학부">법학부</option>
				<option value="글로벌에디슨아카데미">글로벌에디슨아카데미</option>
				<option value="산업교육학부">산업교육학부</option>
				<option value="국제법률대학원">국제법률대학원</option>
				<option value="상담대학원">상담대학원</option>
				<option value="교육대학원">교육대학원</option>
				<option value="국제경영대학원">국제경영대학원</option>
				<option value="통역번역대학원">통역번역대학원</option>
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>팀교수님</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark4" size="20" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;교수님&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark5" size="20" maxlength="100" class="formstyle4" value="{REMARK5}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>E-mail</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark6" size="40" maxlength="100" class="formstyle4" value="{REMARK6}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>거주지</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"><input type="radio" name="remark7" value="생활관" checked style="border-width : 0px;">생활관&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="remark7" value="외부거주" style="border-width : 0px;">외부거주&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>상담방법</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"><input type="radio" name="remark8" value="방문" checked style="border-width : 0px;">방문&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="remark8" value="E-mail" style="border-width : 0px;">E-mail&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="middle">&nbsp;<span class=menuTitle>희망상담일시</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed"> 
			<input type="text" name="remark9" size="40" maxlength="100" class="formstyle4" value="{REMARK9}" />&nbsp;<font color="#ADADAD">Ex : 2010/04/05 14시 30분</font></span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		<td valign="top">&nbsp;<span class=menuTitle>내&nbsp;&nbsp;&nbsp;용</span></td>
		<td width="1" valign="top"><span class=menuBorder>|</span></td>
		<td valign="top"><span class="genmed">
