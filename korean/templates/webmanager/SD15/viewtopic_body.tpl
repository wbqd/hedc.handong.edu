...
<table width="95%" cellspacing="0" cellpadding="2" border="0">
	...
	<tr> 
		...
		<td width="10%" nowrap="nowrap" height="29" align="right"><span class=menuTitle>{MENU_LANG_DATE}</span>&nbsp;</td>
		<td width="3" valign="middle"><span class=menuBorder>|</span></td>
		<td width="36%"><span class="postdetails">{postrow.POST_DATE}</span></td>
	</tr>
	<tr> 
		<td colspan="6" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
<table width="95%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr> 
	<td align="left" valign="middle" nowrap="nowrap"><span class="nav">{POST_IMG}{REPLY_IMG}<a href="{U_VIEW_FORUM}"><img src="templates/webmanager/images/icon_list.gif" border="0" alt="{L_VIEW_FORUM}" align="middle" /></a>&nbsp;<a href="javascript:void(window.open('{PRINTER_URL}', 'Popup','toolbar=no, location=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=650, height=600'));"><img src="{PRINTER_IMG}" border="0" align="middle" /></a>
	<!-- BEGIN switch_user_logged_in -->
