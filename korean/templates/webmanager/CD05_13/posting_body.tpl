...
<table border="0" cellpadding="3" cellspacing="0" width="95%">
	...
	<tr> 
		...
		<td><span class="genmed"> 
			<input type="text" name="remark1" size="30" maxlength="100" class="formstyle4" value="{REMARK1}" />&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark3" size="30" maxlength="100" class="formstyle4" value="{REMARK3}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">Ex: hedc@handong.edu</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr> 
		...
		<td width="1"><span class=menuBorder>|</span></td>
		<td><span class="genmed"> 
			<input type="text" name="remark4" size="20" maxlength="100" class="formstyle4" value="{REMARK4}" />&nbsp;&nbsp;<span style="color: #aaaaaa;">(학생만 기재)</span>&nbsp;</span></td>
	</tr>
	<tr> 
		<td colspan="3" height="1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td valign="top"><span class="genmed">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td>
						<span class="genmed"> 
						<textarea name="message" rows="15" cols="85" wrap="virtual" class="formstyle4" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
						</span>
					</td>
				</tr>
			</table>
